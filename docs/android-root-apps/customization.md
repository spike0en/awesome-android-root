...
head:
  - - link
    - rel: canonical
      href: https://awesome-android-root.org/android-root-apps/customization
  - - meta
    - property: og:type
      content: article
  - - meta
  ...
  - - meta
    - property: og:url
      content: https://awesome-android-root.org/android-root-apps/customization
  - - meta
    - property: og:image
  ...
  - - meta
    - name: keywords
      content: android root apps, root tools, magisk modules, lsposed, kernelsu, customization, themes, UI tweaks, launchers, Xposed
  - - meta
    - name: robots
  ...
  - - meta
    - property: article:tag
      content: Android Root, Root Apps, Magisk, LSPosed, KernelSU, customization, themes
  - - meta
